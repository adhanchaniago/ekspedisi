        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <div class="container">
                        <a class="navbar-brand" href="./index.php"><img src="./Assets/logo/logo syn cepat.png"
                                alt=""></a>
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-item nav-link <?= isset($_GET['page'])? $_GET['page'] == 'regular'?'active' :'' :''?>" href="?page=regular">REGULER</a>
